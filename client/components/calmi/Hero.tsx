export default function Hero() {
  return (
    <section className="text-center py-10 md:py-16 space-y-4">
      ...
      <p className="max-w-2xl mx-auto text-muted-foreground">Calmi is your gentle companion for tough moments. Chat with an empathetic AI, breathe with guidance, and keep a private journal.</p>
